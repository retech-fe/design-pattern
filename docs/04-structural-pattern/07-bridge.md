...
可以看到由于包包的结构被分别抽象为几个部件的组合，部件的实例化是在部件类各自的构造函数中完成，因此部件之间的实例化不会相互影响

使用了桥接模式，我们还可以任意组合包包类型、包包大小、包包颜色，为后续代码提供了很好的拓展性；因此新产品的创建也变得容易，这就是桥接模式的好处。
...
![](https://raw.githubusercontent.com/retech-fe/image-hosting/main/img/2022/12/06/23-11-11-e79a738666bda1ad1a5461027a5a0c43-20221206231110-6f2599.png)
